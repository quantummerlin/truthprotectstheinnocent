...
<section class="section" style="background: var(--color-gray-900, #111827); padding: 3rem 0;">
    <div class="container">
        <div class="section-header" style="color: white;">
            ...
            <p style="color: rgba(255,255,255,0.75);">763 osoby z całego świata publicznie skomentowały, domagając się natychmiastowego powrotu Utopii, Galoriana i Blue Bell.</p>
        </div>
        <div class="stats-counter-wrapper">
            ...
            <div class="stats-counter-grid">
                <div class="stat-item"><div class="stat-number">763</div><div class="stat-label">Publicznych Komentarzy</div><div class="stat-change up">↑ 2 źródła</div></div>
                <div class="stat-item"><div class="stat-number">678</div><div class="stat-label">Unikalnych Głosów</div><div class="stat-change up">↑ +480 partia 2</div></div>
                <div class="stat-item highlight"><div class="stat-number">95%</div><div class="stat-label">Popiera Rodzinę</div><div class="stat-change">Jednogłośnie</div></div>
                <div class="stat-item"><div class="stat-number">10+</div><div class="stat-label">Krajów</div><div class="stat-change up">↑ Międzynarodowo</div></div>
            </div>
            <div class="stats-counter-footer">
                <span>Zaktualizowano: 8 marca 2026</span>
        ...
        <div style="text-align:center;margin-top:1.5rem;">
            <a href="/public-voice/" class="btn" style="background:linear-gradient(135deg,#e67e22,#f39c12);color:#1a1a00;font-weight:700;border:none;padding:.75rem 2rem;border-radius:2rem;">Czytaj Wszystkie 763 Głosy →</a>
